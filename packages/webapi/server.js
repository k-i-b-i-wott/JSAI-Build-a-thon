...
import pdfParse from 'pdf-parse';
 // Ensure you have pdf-parse installed: npm install pdf-parse
...
console.log("Azure endpoint:", process.env.AZURE_INFERENCE_SDK_ENDPOINT);
console.log("Azure key exists:", !!process.env.AZURE_INFERENCE_SDK_KEY);
...
// heck if a session history already exists for a given session ID. If it doesn't, it will create a new one.
